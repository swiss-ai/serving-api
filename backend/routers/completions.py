...
async def chat_completion(
    ...
    # Checked before _resolve_route rewrites the id, so the policy lookup
    # keys off what the caller asked for (and, for SwissAI-Research/ ids,
    # its upstream form too).
